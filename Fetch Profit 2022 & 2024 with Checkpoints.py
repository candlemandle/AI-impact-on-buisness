...
enriched_path = '/Users/c4ndlemandle/Downloads/enriched_dataset.csv'
partial_path = '/Users/c4ndlemandle/Downloads/partial_results.csv'
final_path = '/Users/c4ndlemandle/Downloads/final_dataset.csv'
...
if os.path.exists(partial_path):
    ...
    print(f"🔁 Resuming from checkpoint. Already processed: {len(processed_tickers)} tickers.")
else:
...
for count, ticker in enumerate(remaining_tickers, 1):
    try:
        ...
        print(f"⚠️ Error fetching for {ticker}: {e}")
    ...
    if count % 10 == 0 or count == len(remaining_tickers):
        if new_results:
            ...
            print(f"💾 Saved checkpoint after {count} tickers.")
            new_results = []
